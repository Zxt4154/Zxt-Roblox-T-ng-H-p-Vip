...
ImageButton.Image = "http://www.roblox.com/asset/?id=78476755859828"
...
local Tabs = {
        ...
        Main2=Window:AddTab({ Title="Farm Chest" }),
        Main3=Window:AddTab({ Title="Script Hop" }),
       Main4=Window:AddTab({ Title="auto bounty }),
}
    ...
    Tabs.Main0:AddButton({
    Title = "Youtuber",
    Description = "Zxt Roblox",
    Callback = function()
        setclipboard("https://youtube.com/@zxt-roblox")
    end
})
    ...
    Description = " Zxt Roblox",
    Callback = function()
        setclipboard("https://www.tiktok.com/@zxtroblox0")
    end
})
...
Tabs.Main3:AddButton({
    ...
    Description="",
    Callback=function()
	  loadstring(game:HttpGet("https://raw.githubusercontent.com/SHADOW470-CODE/werty/refs/heads/main/werty"))()
  end
})
